...
public class CasCallbackController {
  ...
  public void casCallback(@RequestParam String code, @RequestParam String qs, HttpSession session,
    ...
    ResponseEntity<HashMap> responseEntity =
        restTemplate
            .exchange(CAS_USER_URL, HttpMethod.GET, httpEntity, HashMap.class, uriVariables);
