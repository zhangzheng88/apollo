...
CREATE TABLE `Audit` (
  ...
  `EntityId` int(10) unsigned DEFAULT 0 COMMENT '记录ID',
...
CREATE TABLE `Cluster` (
  `Id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `Name` varchar(32) NOT NULL NOT NULL DEFAULT '' COMMENT '集群名字',
  `AppId` varchar(32) NOT NULL NOT NULL DEFAULT '' COMMENT 'App id',
...
CREATE TABLE `GrayReleaseRule` (
  ...
  `Rules` varchar(1600) DEFAULT '[]' COMMENT '灰度规则',
...
CREATE TABLE `Instance` (
  ...
  `Ip` varchar(32) NOT NULL NOT NULL DEFAULT '' COMMENT 'instance ip',
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
CREATE TABLE `InstanceConfig` (
  `Id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增Id',
  `InstanceId` int(11) unsigned DEFAULT 0 COMMENT 'Instance Id',
  `ConfigAppId` varchar(32) NOT NULL DEFAULT 'default' COMMENT 'Config App Id',
  `ConfigClusterName` varchar(32) NOT NULL DEFAULT 'default' COMMENT 'Config Cluster Name',
  `ConfigNamespaceName` varchar(32) NOT NULL DEFAULT 'default' COMMENT 'Config Namespace Name',
  `ReleaseKey` varchar(64) NOT NULL NOT NULL DEFAULT '' COMMENT '发布的Key',
  `ReleaseDeliveryTime` DATETIME NOT NULL DEFAULT '1970-01-01' COMMENT '配置获取时间',
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后修改时间',
  PRIMARY KEY (`Id`),
...
CREATE TABLE `Release` (
  ...
  `Comment` varchar(256) NOT NULL DEFAULT '' COMMENT '发布说明',
  `AppId` varchar(64) NOT NULL DEFAULT 'default' COMMENT 'AppID',
  `ClusterName` varchar(64) NOT NULL DEFAULT 'default' COMMENT 'ClusterName',
  `NamespaceName` varchar(64) NOT NULL DEFAULT 'default' COMMENT 'namespaceName',
...
CREATE TABLE `ReleaseMessage` (
  ...
  `Message` varchar(1024) NOT NULL NOT NULL DEFAULT '' COMMENT '发布的消息内容',
  `updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后修改时间',
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`Id`),
  KEY `updated_at` (`updated_at`),
