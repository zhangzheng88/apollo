 ...
 * bytes.
 *
 * This class detects these bytes and, if required, can automatically skip them and return the
 * subsequent byte as the first byte in the stream.
 *
 * The {@link ByteOrderMark} implementation has the following pre-defined BOMs: <ul> <li>UTF-8 -
 * {@link ByteOrderMark#UTF_8}</li> <li>UTF-16BE - {@link ByteOrderMark#UTF_16LE}</li> <li>UTF-16LE
 * - {@link ByteOrderMark#UTF_16BE}</li> <li>UTF-32BE - {@link ByteOrderMark#UTF_32LE}</li>
 * <li>UTF-32LE - {@link ByteOrderMark#UTF_32BE}</li> </ul>
 *
 *
...
public class BOMInputStream extends ProxyInputStream {
  ...
  /**
   * Invokes the delegate's <code>read(byte[])</code> method, detecting and optionally skipping
   * BOM.
   *
   * @param buf the buffer to read the bytes into
