...
public class NamespaceBranchController {
  ...
  public NamespaceDTO createBranch(@PathVariable String appId,
    ...
    Namespace createdBranch = namespaceBranchService
  ...
  public void deleteBranch(@PathVariable String appId, @PathVariable String clusterName,
    ...
    namespaceBranchService
        .deleteBranch(appId, clusterName, namespaceName, branchName, NamespaceBranchStatus.DELETED,
            operator);
  ...
  private void checkBranch(String appId, String clusterName, String namespaceName,
    ...
    if (childNamespace == null) {
      throw new BadRequestException(
          String.format("Namespace's branch not exist. AppId = %s, ClusterName = %s, "
